...
Das Formular für die Bearbeitung von Datensätzen wird mit TypoScript definiert.
...
Die zugehörige *editAction*, welche die Logik zum Bearbeiten bereitstellt sieht wie folgt aus:
...
In dieser Action werden die Eingaben entsprechend Deiner Konfiguration validiert und der Datensatz aktualisiert. Für die Ausgabe im Frontend benötigst Du dann noch das folgende Fluid-Template:
...
Nach diesem Schritt solltest Du in der Lage sein, bestehende Objekte mit dem angemeldeten Frontend-Benutzer zu bearbeiten.
