...
The form used to create new data records is defined in TypoScript. The Typoscript should define at a minimum all fields required by the object, e.g. the *Slug* field.
...
The logic is contained in the corresponding *createAction* function, as shown below:
...
The action function validates user input against your configuration, sets default values and sets the current frontend user. For correct display in the frontend you will then need the following Fluid template:
